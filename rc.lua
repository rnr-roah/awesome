...
tyrannical.tags = {
  ...
  } ,
  {
    ...
    class = {
      ...
      "Chromium"      , "Brave-browser"        , "minefield"     }
  } ,
  
  {
    ...
    class ={
      "Kate", "KDevelop", "Code", "Code::Blocks" , "DDD", "kate4"}
  } ,
  {
    name = "Files -4",
    init        = true,
  ...
  
  {
    ...
    class  = {
      "VirtualBox", "virtualbox", "VirtualBox Manager", "virtualbox manager", "VirtualBoxVM", "+VirtualBoxVM"
    }
  } ,
...
---- Start of Customized
  ...
  awful.key({ modkey,           }, "c", function () awful.spawn("code") end,
    {description = "open vscode", group = "Customized launchers"}),
  awful.key({ modkey, "Shift"   }, "b", function () awful.spawn("brightness-controller") end,
    {description = "open eye protector", group = "Customized launchers"}),
