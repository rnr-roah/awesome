...
tyrannical.tags = {
  {
    ...
    icon        = "/home/roah/.config/awesome/icons/terminal.png",                
  ...
  } ,
  {
    ...
    exclusive   = true,
    screen      = {1,2},
    icon        = "/home/roah/.config/awesome/icons/browser.png",                 -- Use this icon for the tag (uncomment with a real path)
  ...
  
  {
    ...
    exclusive   = true,
    screen      = 1,
    icon        = "/home/roah/.config/awesome/icons/vm.png",
